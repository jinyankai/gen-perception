...
REQUIRED = [
    ...
    "perception_diffusion/models/visual_latent.py",
    "perception_diffusion/models/pretrained.py",
    ...
    "perception_diffusion/training/noise.py",
    "perception_diffusion/training/runner.py",
    "perception_diffusion/inference/runner.py",
    "scripts/framework_smoke.py",
    "scripts/infer.py",
    "scripts/analyze_vae_reconstruction.py",
    "scripts/validate_conditions.py",
    "scripts/evaluate.py",
    "docs/target-encoding-strategies.md",
    "docs/real-training-and-inference.md",
